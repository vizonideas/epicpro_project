...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.slut'
        db.add_column(u'projects_team', 'slut',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 2, 13, 0, 0), max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.slut'
        db.delete_column(u'projects_team', 'slut')
    ...
    models = {
        ...
        u'projects.team': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'resumen': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'slut': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
